...
def read_interpro(train_interpro_file, evaluate_interpro_file, test_interpro_file):

    with open(train_interpro_file, 'rb') as fr:
        train_interpro = pkl.load(fr)

    with open(evaluate_interpro_file, 'rb') as fr:
        evaluate_interpro = pkl.load(fr)

    with open(test_interpro_file, 'rb') as fr:
        test_interpro = pkl.load(fr)

    return train_interpro, evaluate_interpro, test_interpro
